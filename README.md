...
<!--next/previous buttons-->
<div style="clear:both"></div>
<button type="button" id="lecture3prev" class="btn btn-primary pull-left" onclick="$('a[href=\'#lecture2\']').tab('show')">
  <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Previous
</button>
<button type="button" class="btn btn-primary pull-right" onclick="$('a[href=\'#review\']').tab('show')">
...
<button type="button" id="reviewprev" class="btn btn-primary pull-left" onclick="$('a[href=\'#lecture3\']').tab('show')">
  <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Previous
</button>
<div style="clear:both"></div>
</div>
